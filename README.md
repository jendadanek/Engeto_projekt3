Instalace balíèkù:
1. Na dolní lištì otevøete záložku Python Packages.
2. Do vyhledavaèe napište bs4 a na pravém okraji najdete tlaèítko install.
3. Stejný proces zopakujte pro instalaci balíèku requests.

Program:
Výzvy:
1. Jak vytáhnout údaje z více tabulek.
2. Jak vytáhnout údaje z obcí v daném okrese.
3. Jak se vypoøádat s faktem, že v každém kraji kandiduje jiná struktura stran.
